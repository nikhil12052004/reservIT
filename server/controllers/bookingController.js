...
exports.storeOTP = async (req, res) => {
    try {
        ...
        res.json({ success: true, message: 'OTP stored for verification' });
    } catch (error) {
...
// ========== CONFIRM BOOKING WITH OTP (User - EmailJS) ==========
exports.confirmBookingWithOTP = async (req, res) => {
    try {
